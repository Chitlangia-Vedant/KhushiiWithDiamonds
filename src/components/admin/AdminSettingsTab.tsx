          ...
          <div className="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-gray-50 transition-colors">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <div className="text-[10px] sm:text-xs text-gray-500 mt-0.5 sm:mt-1 flex items-center flex-wrap">
                  Live API Rate: 
                  {goldPrice > 0 ? (
                    <span className="font-bold text-gray-700 ml-1">₹{goldPrice}/g</span>
                  ) : (
                    <span className="font-bold text-red-600 flex items-center ml-1 bg-red-50 px-1.5 py-0.5 rounded border border-red-100 shadow-sm">
            ...
            <div className="flex items-center gap-4 sm:gap-8 bg-white sm:bg-transparent p-3 sm:p-0 border border-gray-100 sm:border-none rounded-lg shadow-sm sm:shadow-none">
              ...
              <div className="flex flex-col items-center">
                ...
                <input 
                  ...
                  onChange={e=>setLocalOverride(e.target.checked)} 
                  className="rounded border-gray-300 text-yellow-600 focus:ring-yellow-500 h-4 w-4 sm:h-5 sm:w-5 cursor-pointer mt-0.5 sm:mt-1" 
                />
              </div>
            </div>
          </div>
