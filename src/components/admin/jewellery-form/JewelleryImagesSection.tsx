    ...
    <div className="space-y-4">
        ...
        <div className="mb-2">
          ...
          <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
            ...
            {currentImages.map((imageUrl, index) => (
              <div key={`current-${index}`} className="relative group aspect-square bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
          ...
          {/* 1. Upload Button (Acts as a grid item) */}
          ...
          {/* 2. New Images Previews (Side-by-side with upload button) */}
